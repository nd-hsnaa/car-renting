...
public class CarRentingApplication {
    ...
    CommandLineRunner runner() {
        return args -> {
            ...
            Car car1 = new Car("Corolla : Toyota", "Mohammed Hachami", 2001, 1, true);
            Car car2 = new Car("308 : Peugeot", "Mohammed Batrone", 2000, 1, true);
            Car car3 = new Car("Tucson : Hyundai", "Taha Bouasria", 2012, 3, true);
            Car car4 = new Car("Focus : Ford", "Taha Elghabi", 2007, 2, true);
            Car car5 = new Car("Astra : Opel", "Houda Oukessou", 2013, 3, true);
            Car car6 = new Car("CLA : Mercedes", "Mohammed Idrissi", 1002, 2, true);
            Car car7 = new Car("Logan : Dacia", "Oussama Rachidi", 2002, 2, true);
            Car car8 = new Car("Clio4 : Renault", "Yassir Kassimi", 2011, 1, true);
            Car car9 = new Car("308 : Peugeot", "Intissar Labiad", 2009, 1, true);
            Car car10 = new Car("Golf : VolksWagen", "Imad Slimani", 2015, 3, true);
            // Car car11 = new Car("Fabia : SKoda", "Aaziz Taleb", 2005, 1, true);
            // Car car12 = new Car("Uno : Fiat", "Achak Nizar", 2008, 1, true);
            // Car car13 = new Car("Punto : Fiat", "Bahou Basma", 2000, 2, true);
            // Car car14 = new Car("Kuga : Ford", "Ibrahim Jouhari", 2001, 3, true);
            // Car car15 = new Car("ClasseE : Mercedes", "Salim Zaidi", 2005, 3, true);
            // Car car16 = new Car("Tiguan : VolksWagen", "Hicham Taibi", 2016, 2, true);
            // Car car17 = new Car("Evoque : RangeRover", "Alae Abjabja", 2014, 1, true);
            // Car car18 = new Car("Fiesta : Ford", "Ismail Ouafi", 2012, 2, true);
            // Car car19 = new Car("Micra : Nissan", "Khalil Amraoui", 2009, 2, true);
            // Car car20 = new Car("Qashqai : Nissan", "Omar Mouad", 2016, 3, true);
            // Car car21 = new Car("Megane : Renault", "Manal Riad", 2006, 3, true);
            // Car car22 = new Car("Leon : Seat", "Amine Meftah", 2015, 1, true);
            // Car car23 = new Car("Picanto : Kia", "Abdellah Chadid", 2001, 2, true);
